    ...
    (list
     (directions
      ...
      (if (= "sortition" (:election-district-type subject))
        "However, imagine that instead of electing a candidate, any citizen 18 years or older in your riding can put his or her name up for consideration, and one person will be <strong>randomly selected</strong> to serve."
        "This district also defines who can vote for candidates for office.")

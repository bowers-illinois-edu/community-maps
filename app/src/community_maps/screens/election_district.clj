...
(defscreen election-district-answers
  [subject]
  (directions
   (<< "Here is the map you drew of your ideal district. We will now ask you some questions about it. Remember that this district decides who would represent you in the House of Commons, and that person would be chosen by ~{(if (= \"sortition\" (:election-district-type subject)) \"a lottery\" \"an election\")}." )

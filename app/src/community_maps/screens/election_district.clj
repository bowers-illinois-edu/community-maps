...
(defscreen election-district-answers
  ...
  (directions
   ...
   (<< "While there is not an actual person representing this district, please imagine what type of person you think would be  ~{(if (= \"sortition\" (:election-district-type subject)) \"\" \"an election\")} "))

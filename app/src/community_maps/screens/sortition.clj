  ...
  (let [[lat lng] (split (get-in subject [:address :address-finder :latlng]) #",")]
    (question
     (list
      ...
      (when (= :federal (:draw-district-display subject)) "The map displays your current riding to give you a sense of scale. You do not have to follow this district for your drawing, though you may if you wish.")
     ...
     (scribble-map :community lat lng (gis/kml-url "pr" 10)))))

...
;;;Q25. Question:
  ...
  (group-sliders
   ...
   [:p "Now we would like to get your feelings about some groups in Canadian society. For each of the following groups, we would like you to rate it with what we call a feeling thermometer."]
